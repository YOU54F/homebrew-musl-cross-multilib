...
class MuslCrossPowerpcSf < Formula
  ...
  option "without-powerpc-sf", "Build cross-compilers targeting powerpc-linux-muslsf"
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_sonoma: "7a3b5fcabfa29794b30a38f033b3a3914b59c7b6b4515d52333584d6e9ced097"
  end
