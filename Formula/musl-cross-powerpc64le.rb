...
class MuslCrossPowerpc64le < Formula
  ...
  option "without-powerpc64le", "Build cross-compilers targeting powerpc64le-linux-musl"
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_sonoma: "349410adb6c05390ab9d6f62f6ef25cf2891cafc2a87ba43b7e907dbf92d0d53"
  end
