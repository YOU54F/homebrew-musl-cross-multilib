...
class MuslCrossArmHf < Formula
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_sonoma: "99e6934bb8dedfe7bdd8d46f72bb68a28f40c202128846bde3bce65cf0776f16"
  end
  option "without-arm-hf", "Build cross-compilers targeting arm-linux-musleabihf"
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_sonoma: "cc5c8788360a97e2b52cf9954373556767ac1b709933376fea57662c92624f2e"
  end
