...
class MuslCrossPowerpc < Formula
  ...
  option "without-powerpc", "Build cross-compilers targeting powerpc-linux-musl"
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_sonoma: "79899f5d490c141f09c024a1a2fc2a26006e4680b0ab23eb46b0786811b5b1ec"
  end
