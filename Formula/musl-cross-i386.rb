...
class MuslCrossI386 < Formula
  ...
  option "without-i386", "Build cross-compilers targeting i386-linux-musl"
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_sonoma: "ba5821da91bf0a2f5bf688abfee37bc298ca355f3979ce59660baaf3e6001314"
  end
