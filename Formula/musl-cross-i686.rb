...
class MuslCrossI686 < Formula
  ...
  option "without-i686", "Build cross-compilers targeting i686-linux-musl"
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_sonoma: "ed0d808a51369a93cd74cec151cf70067a452d43441e0937c2b7a1f57a94f013"
  end
