...
class MuslCrossPowerpc64 < Formula
  ...
  option "without-powerpc64", "Build cross-compilers targeting powerpc64-linux-musl"
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_sonoma: "e5c6f075e21b7bcccefa81264671671d274f5b69bc454230b83ecc458431b9d7"
  end
