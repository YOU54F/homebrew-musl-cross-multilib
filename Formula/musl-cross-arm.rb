...
class MuslCrossArm < Formula
  ...
  option "without-arm", "Build cross-compilers targeting arm-linux-musleabi"
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_sonoma: "c63b779dd3ec30cd6449bcca1f78cf9137d619c71653e341337d0ca093a48dc8"
  end
