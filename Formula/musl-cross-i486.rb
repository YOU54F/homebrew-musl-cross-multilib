...
class MuslCrossI486 < Formula
  ...
  option "without-i486", "Build cross-compilers targeting i486-linux-musl"
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_sonoma: "ba484aee179a28745c48583dcaad05f2ab41c5e6236b00f91fbfe936309f0987"
  end
