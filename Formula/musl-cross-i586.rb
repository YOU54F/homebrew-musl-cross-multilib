...
class MuslCrossI586 < Formula
  ...
  option "without-i586", "Build cross-compilers targeting i586-linux-musl"
  bottle do
    sha256 cellar: :any_skip_relocation, arm64_sonoma: "22593555f1e821aff71a125f9b730ebe37e1bd05163dc30234235b8d537ea6bd"
  end
